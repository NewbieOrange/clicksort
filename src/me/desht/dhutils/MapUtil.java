...
public class MapUtil
{
    ...
    private static final byte[] chatColorToMapPalette = new byte[] { 119, // 0
                                                                          // black
            48, // 1 blue
            28, // 2 green
            21, // 3 cyan
    ...
    static
    {
        final Color[] baseMapColors = new Color[] { new Color(0, 0, 0, 0),
                ...
                new Color(255, 252, 245), new Color(216, 127, 51),
                new Color(178, 76, 216), new Color(102, 153, 216),
                new Color(229, 229, 51), new Color(127, 204, 25),
                new Color(242, 127, 165), new Color(76, 76, 76),
                new Color(153, 153, 153), new Color(76, 127, 153),
                new Color(127, 63, 178), new Color(51, 76, 178), new Color(102, 76, 51),
                new Color(102, 127, 51), new Color(153, 51, 51), new Color(25, 25, 25),
                new Color(250, 238, 77), new Color(92, 219, 213),
                new Color(74, 128, 255), new Color(0, 217, 58), new Color(21, 20, 31),
                new Color(112, 2, 0) };
        ...
        for (int i = 0; i < baseMapColors.length; ++i)
        {
            ...
            mapColors[i * 4 + 0] = new Color((int) (bc.getRed() * 180.0 / 255.0 + 0.5),
                    (int) (bc.getGreen() * 180.0 / 255.0 + 0.5),
                    (int) (bc.getBlue() * 180.0 / 255.0 + 0.5), bc.getAlpha());
            mapColors[i * 4 + 1] = new Color((int) (bc.getRed() * 220.0 / 255.0 + 0.5),
                    (int) (bc.getGreen() * 220.0 / 255.0 + 0.5),
                    (int) (bc.getBlue() * 220.0 / 255.0 + 0.5), bc.getAlpha());
            mapColors[i * 4 + 2] = bc;
            mapColors[i * 4 + 3] = new Color((int) (bc.getRed() * 135.0 / 255.0 + 0.5),
                    (int) (bc.getGreen() * 135.0 / 255.0 + 0.5),
                    (int) (bc.getBlue() * 135.0 / 255.0 + 0.5), bc.getAlpha());
        }
        byte[] r = new byte[mapColors.length], g = new byte[mapColors.length], b = new byte[mapColors.length], a = new byte[mapColors.length];
