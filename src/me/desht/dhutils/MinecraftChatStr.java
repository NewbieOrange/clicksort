...
public class MinecraftChatStr
{
    ...
    public static String getChatColor(String col)
    {
        ...
        {
            return ChatColor.BLACK.toString();// "\u00A70";
                                              // //String.format("\u00A7%x",
                                              // 0x0);//
        }
        else if (col.equals("blue") || col.equals("dark blue"))
        {
            return ChatColor.DARK_BLUE.toString();// "\u00A71"; //
                                                  // String.format("\u00A7%x",
                                                  // 0x1);//
        }
        else if (col.equals("green") || col.equals("dark green"))
        {
            return ChatColor.DARK_GREEN.toString();// "\u00A72"; //
                                                   // String.format("\u00A7%x",
                                                   // 0x2);//
        }
        ...
        else if (col.equals("light gray") || col.equals("light grey"))
        {
            return ChatColor.GRAY.toString();// "\u00A77"; //
                ...
                || col.equals("grey"))
        {
            return ChatColor.DARK_GRAY.toString();// "\u00A78"; //
                                                  // String.format("\u00A7%x",
                                                  // 0x8);//
        }
        else if (col.equals("medium blue"))
        {
            return ChatColor.BLUE.toString();// "\u00A79"; //
                                             // String.format("\u00A7%x",
                                             // 0x9);//
        }
        ...
        {
            return ChatColor.GREEN.toString();// "\u00A7a"; //
                                              // String.format("\u00A7%x",
                                              // 0xA);//
        }
        else if (col.equals("cyan") || col.equals("light blue"))
        {
            return ChatColor.AQUA.toString();// "\u00A7b"; //
                                             // String.format("\u00A7%x",
                                             // 0xB);//
        }
        ...
        {
            return ChatColor.RED.toString();// "\u00A7c"; //
                                            // String.format("\u00A7%x", 0xC);//
        }
        else if (col.equals("pink") || col.equals("light red")
                || col.equals("light purple"))
        {
            return ChatColor.LIGHT_PURPLE.toString();// "\u00A7d"; //
                                                     // String.format("\u00A7%x",
                                                     // 0xD);//
        }
        else if (col.equals("yellow"))
        {
            return ChatColor.YELLOW.toString();// "\u00A7e"; //
                                               // String.format("\u00A7%x",
                                               // 0xE);//
        }
        else if (col.equals("white"))
        {
            return ChatColor.WHITE.toString();// "\u00A7f";
                                              // //String.format("\u00A7%x",
                                              // 0xF);//
        }
        else
