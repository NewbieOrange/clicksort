...
public class Duration
{
     ...
     *             if any number is wrongly specified
     */
        ...
        if (fields.length > 1)
        {
            if (fields.length % 2 == 1)
            {
                throw new IllegalArgumentException(
                        "Odd number of parameters in duration specification");
            }
    ...
    {
        return milliseconds + (seconds + minutes * 60 + hours * 3600 + days * 86400)
                * 1000;
    }
    ...
    public String shortDescription()
    {
        ...
        { // if (days > 0 && milliseconds > 0)
            return String.format("%dd%02d:%02d:%02d.%03d", days, hours, minutes, seconds,
                    milliseconds);
        }
    }
