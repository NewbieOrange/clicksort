...
{
    public static final String BULLET = ChatColor.LIGHT_PURPLE + "\u2022 "
            + ChatColor.RESET;
     ...
     *            The page number.
     * @param wrap
     *            If true, automatically wrap to beginning or end if the page
    ...
    public void showPage(int pageNum)
    {
        ...
        if (sender instanceof Player)
        {
            ...
            for (; i < nMessages && i < pageNum * getPageSize(); ++i)
            {
                if (parseColours)
                {
                    MiscUtil.generalMessage(player, ChatColor.GREEN + "\u250a "
                            + ChatColor.RESET + getLine(i));
                }
                else
                {
                    MiscUtil.rawMessage(player, ChatColor.GREEN + "\u250a "
                            + ChatColor.RESET + getLine(i));
                }
            }
